module github.com/panxiao81/e5renew
...
replace github.com/alexedwards/scs/postgresstore => github.com/alexedwards/scs/postgresstore v0.0.0-20250417082927-ab20b3feb5e9
